...
$cartqty = "1";
$carttotal = 0;
$sqlinsert = "SELECT * FROM tbl_carts WHERE user_email = '$useremail' AND subject_id = '$subjectid'";
...
if ($number_of_result > 0) {
    ...
    if (isset($subid)) {
        ...
        $cartqty = $cartqty + 1;
        $updatecart = "UPDATE `tbl_carts` SET `cart_qty`= '$cartqty' WHERE user_email = '$useremail' AND subject_id = '$subjectid' AND cart_status IS NULL";
